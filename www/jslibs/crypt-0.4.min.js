 ...
 * 
 **/
(function(window,undefined){try{if(typeof($LAB)=='undefined'){throw'';}}catch(e){throw'ezcrypt depends on $LAB!';}if(typeof(ezcrypt)=='undefined'){ezcrypt={};}var window=window,document=window.document,navigator=window.navigator,location=window.location;ezcrypt=function(type,func){if(typeof(window.ez)=='object'){return window.ez;}_this=this;_loaded=false;_aesobj=null;_type={};libs={ENCRYPT_TYPE:{'CLIPPERZ':{'lib':['jslibs/clipperz/MochiKit/MochiKit.js','jslibs/clipperz/MochiKit/Base.js','jslibs/clipperz/MochiKit/Logging.js','jslibs/clipperz/JSON/json2.js','jslibs/clipperz/YUI/Utils.js','jslibs/clipperz/Base.js','jslibs/clipperz/ByteArray.js','jslibs/clipperz/Crypto/SHA.js','jslibs/clipperz/Crypto/AES.js'],'load':'','decrypt':{'func':'Clipperz.Crypto.AES.decrypt','params':{}},'encrypt':{'func':'Clipperz.Crypto.AES.encrypt','key':{'func':'Clipperz.Crypto.SHA.sha256','params':{'func':'Clipperz.ByteArray'}},'block':'Clipperz.ByteArray','params':{}},'sha':'Clipperz.Crypto.SHA.sha256'},'CRYPTO_JS':{'lib':['jslibs/crypto-js/crypto/crypto.js','jslibs/crypto-js/sha1/sha1.js','jslibs/crypto-js/hmac/hmac.js','jslibs/crypto-js/pbkdf2/pbkdf2.js','jslibs/crypto-js/blockmodes/blockmodes.js','jslibs/crypto-js/aes/aes.js'],'load':'','decrypt':{'func':'Crypto.AES.decrypt','params':{}},'encrypt':{'func':'Crypto.AES.encrypt','params':{}},'sha':'Crypto.SHA1'},'GIBBERISH_AES':{},'JSAES':{},'JSCRYPTOLIB':{},'MOVEABLE_TYPE':{},'PIDCRYPT':{'lib':['jslibs/pidCrypt/pidcrypt_util.js','jslibs/pidCrypt/pidcrypt.js','jslibs/pidCrypt/md5.js','jslibs/pidCrypt/aes_core.js','jslibs/pidCrypt/aes_cbc.js'],'load':'pidCrypt.AES.CBC','decrypt':{'func':'decryptText','params':{nBits:128}},'encrypt':{'func':'encryptText','params':{nBits:128}},'sha':'pidCrypt.SHA1'},'SJCL':{},'SLOWAES':{}},type:function(name){try
